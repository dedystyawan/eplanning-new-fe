                ...
                <div class="row" style="padding-bottom:0px; ">
                    <div class="col-sm-2 pull-left " style="padding-bottom:0px">
                        <select id="filterSelect" onchange="gantiLabel()" class="form-control " name="bulan">
                            ...
                            <option value="3" selected>PIC</option>
                        </select>
                    </div>
                    ...
                    <table id="example-skala" class="table  table-bordered table-hover" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center; vertical-align:middle;width:20%">Program Kerja</th>
                                ...
                                <th style="text-align:center; vertical-align:middle;width:%">unit</th>
                        ...
                        <tbody>
                            <?php foreach ($data as $keyrkf => $dt) { ?>
                                <tr>
                                    ...
                                    <td class="proker" id="proker-<?= $dt->rkf_proker; ?>" onclick="window.location.href='<?= base_url() ?>rbb/rkf/show-detail/<?= encrypt_decrypt("encrypt", $dt->rkf_id); ?>';">
                                        <?= cetakv2($dt->rkf_proker); ?>
                                    </td>
                                    <td><b><?= cetakv2($dt->skala_proker_nama); ?></b></td>
                                    <td><?= cetakv2($dt->bsc_nama); ?></td>
                                    <td>
                                        <?php
                                    ...
                                    <td><b><?php echo ($kamusSubdiv[$dt->rkf_unit_pelaksana[0]->unitKerja]); ?></b></td>
                                    <td>
                                        <!-- untuk user admin -->
