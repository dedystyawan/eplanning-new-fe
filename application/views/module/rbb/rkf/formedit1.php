        ...
        <div class="col-sm-12">
            <div class="hpanel hblue">
                ...
                <div class="panel-body">
                    ...
                    <!-- <?php print_r($rkf); ?> -->
                        <!-- form rkf -->
                        <form method="post" action="<?= base_url() ?>rbb/rkf/rkf/insert_edit_rkf/<?= encrypt_decrypt("encrypt", $rkf['rkf_id']); ?>" class="form-horizontal" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="6"  class="col-md-12" style="max-width: 100%;resize:none" name="rkf_proker"><?=$rkf['rkf_proker']?></textarea>
                                    </div>
                                </div>
                            </div>
                            <!-- input visi -->
                                        ...
                                        <div class="col-sm-1 text-right">
                                            <div class="form-group ini_button">
                                                ...
                                                <a class="btn btn-info glyphicon glyphicon-plus add_field_button_corplan ubah_icon"></a>
                                                            ...
                                                            <?php } elseif(!empty($rkf['rkf_coreplan'])) { foreach($rkf['rkf_coreplan'] as $key => $dt){ 
                                    ...
                                    <div class="row  border-bottom cor-kakek">
                                                ...
                                                <div class="col-sm-10 ">
                                                    <table class="table table-striped">
                                                        <tr>
                                                            <td>Target</td>
                                                            <td class="cor-target-td">
                                                                <input type="text" readonly class="form-control cor-target cor-inputan" name="" value="<?=$dataCP->is_inisiatif_cp_target?>" style=" max-width: 100%;background:transparent; border:none">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Sasaran</td>
                                        ...
                                        <div class="col-sm-1 text-right">
                                            <div class="form-group ini_button">
                                                ...
                                                <a class="btn btn-info glyphicon glyphicon-plus add_field_button_corplan ubah_icon"></a>
                                                <?php }else{ ?>
                                                <a class="btn btn-danger glyphicon glyphicon-remove remove_field_corplan ubah_icon"></a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control isuStrategis"  multiple="multiple"  name="isuStrategis[]" style=" max-width: 100%;">
                                            ...
                                            <?php foreach($isuStrategis as $dt){ ?>
                                                <option value="<?=$dt->isu_strategis_id ?>"
                                                <?php if(!empty($rkf['rkf_isu_strategis']) && array_search($dt->isu_strategis_id, $rkf['rkf_isu_strategis']) !== false ) { echo 'selected'; } ?>
                                                ><?=$dt->isu_strategis_nama   ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-prog-trans" style="max-width: 90%;">
                                            ...
                                            <option value="1" <?=(!empty($rkf['rkf_transformasi_bpd'])) ? "selected": ""; ?>>Ya</option>
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-workstream" name="rkf_transformasi_bpd" style="max-width: 90%;" <?=(!empty($rkf['rkf_transformasi_bpd'])) ? "": "disabled"; ?>>
                                            <option value="0">Pilih</option>
                                            <?php foreach ($transformasi as $dt) { ?>
                                                <option value="<?= $dt->transformasi_bpd_id ?>" <?=($dt->transformasi_bpd_id == $rkf['rkf_transformasi_bpd']) ? "selected": ""; ?>  ><?= $dt->transformasi_bpd_nama ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-rakb" style="max-width: 90%;">
                                            <option value="" disabled selected>Pilih</option>
                                            <option value="1" <?=(!empty($rkf['rkf_rakb'])) ? "selected": ""; ?>>Ya</option>
                                            <option value="0">Tidak</option>
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-stratbid" name="rkf_rakb" style="max-width: 90%;" <?=(!empty($rkf['rkf_rakb'])) ? "": "disabled"; ?>>
                                            <option value="0">Pilih</option>
                                            <?php foreach ($datarakb as $dt) { ?>
                                                <option value="<?= $dt->rakb_id ?>" <?=($dt->rakb_id == $rkf['rkf_rakb']) ? "selected": ""; ?>  ><?= $dt->rakb_nama ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="rkf_status_proker" style="max-width: 90%;">
                                            <option value="">Pilih</option>
                                            <?php
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="rkf_skala_proker" style="max-width: 90%;">
                                            <option value="">Pilih</option>
                                            <?php
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-katproker" name="rkf_kat_proker" style=" max-width: 90%;">
                                            <option value="">Pilih</option>
                                            <?php
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="rkf_bsc" style=" max-width: 90%;">
                                            <option value="">Pilih</option>
                                            <?php
                                              if(!empty($all->allBSC)){
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="rkf_konsultan" style=" max-width: 100%;">
                                    ...
                                    <div class="row" style="">
                                        ...
                                        <div class="col-sm-1 text-right">
                                            <div class="form-group ini_button">
                                                ...
                                                <?php }else{ foreach ($rkf['rkf_tlaudit'] as $key => $value) { ?>
                                <div class="tl-bapak">
                                    <div class="row" style="">
                                        <div class="col-sm-9">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <select class="form-control input-tahunauditnya" name="tahunaudit[]" style=" max-width: 100%;">
                                                    ...
                                                    <?php $n = 6;
                                                    for ($x = date("Y") - 1; $n > 0; --$x) { ?>
                                                        <option value="<?= $x ?>" <?php if($value['tahunAudit']== $x) {echo 'selected'; } ?> ><?= $x ?></option>
                                                    <?php --$n;
                                                    } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-sm-1 text-right">
                                            ...
                                            <?php if($key == 0){ ?>
                                                <a class="btn btn-info glyphicon glyphicon-plus add_field_button_tlaudit ubah_icon"></a>
                                            <?php } else{ ?>
                                                <a class="btn btn-danger glyphicon glyphicon-remove remove_field_tlaudit ubah_icon"></a>
                                            <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <?php }else{ foreach ($rkf['rkf_tujuan_proker'] as $key=> $value) { ?>
                                <div class="tujuan-bapak">
                                    <div class="row" style="">
                                        <div class="col-sm-11">
                                            <div class="form-group">
                                                <input type="text" name='rkf_tujuan_proker[]' value="<?=$value?>" placeholder='Tujuan Program Kerja' class="form-control input-tujuannya" />
                                            </div>
                                        </div>
                                        <div class="col-sm-1 text-right">
                                            <div class="form-group ini_button">
                                            <?php if($key == 0){ ?>
                                                <a class="btn btn-info glyphicon glyphicon-plus add_field_button_tujuan ubah_icon"></a>
                                            <?php } else{ ?>
                                                <a class="btn btn-danger glyphicon glyphicon-remove remove_field_tujuan ubah_icon"></a>
                                            <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tooltip-demo ">
                                ...
                                <?php if(empty($rkf['rkf_indikator']->rkf_indikator_output))  { ?>
                                ...
                                <?php }else { foreach ($rkf['rkf_indikator']->rkf_indikator_output as $key => $value) { ?>
                                    <div class="output-bapak">
                                        <div class="row" style="">
                                            <div class="col-sm-1">
                                            </div>
                                            <div class="col-sm-10">
                                                <div class="form-group">
                                                    <input type="text"  name='rkf_indikator_output[]' placeholder='Uraian' class="form-control input-outputnya" style="max-width:100%" value="<?=$value ?>" />
                                                </div>
                                            </div>
                                            <div class="col-sm-1 text-right">
                                                <div class="form-group ini_button">
                                                <?php if($key == 0){ ?>
                                                    <a class="btn btn-info glyphicon glyphicon-plus add_field_button_output ubah_icon"></a>
                                            <?php } else{ ?>
                                                <a class="btn btn-danger glyphicon glyphicon-remove remove_field_output ubah_icon"></a>
                                            <?php } ?>
                                ...
                                <?php if(empty($rkf['rkf_indikator']->rkf_indikator_outcome))  { ?>
                                ...
                                <?php }else{ foreach ($rkf['rkf_indikator']->rkf_indikator_outcome as $key=> $value) { ?>
                                    <div class="outcome-bapak">
                                        <div class="row" style="">
                                            <div class="col-sm-1">
                                            </div>
                                            <div class="col-sm-10">
                                                <div class="form-group">
                                                    <input type="text"  name='rkf_indikator_outcome[]' placeholder='Uraian' class="form-control input-outcomenya" style="max-width:100%" value="<?=$value ?>" />
                                                </div>
                                            </div>
                                            <div class="col-sm-1 text-right">
                                                <div class="form-group ini_button">
                                                <?php if($key == 0){ ?>
                                                    <a class="btn btn-info glyphicon glyphicon-plus add_field_button_outcome ubah_icon"></a>
                                            <?php } else{ ?>
                                                <a class="btn btn-danger glyphicon glyphicon-remove remove_field_outcome ubah_icon"></a>
                                            <?php } ?>
                                ...
                                <?php if(empty($rkf['rkf_indikator']->rkf_indikator_impact))  { ?>
                                ...
                                <?php }else{ foreach ($rkf['rkf_indikator']->rkf_indikator_impact as $key => $value) { ?>
                                    <div class="impact-bapak">
                                        <div class="row" style="">
                                            <div class="col-sm-1">
                                            </div>
                                            <div class="col-sm-10">
                                                <div class="form-group">
                                                    <input type="text"  name='rkf_indikator_impact[]' placeholder='Uraian' class="form-control input-impactnya" style="max-width:100%" value="<?=$value ?>" />
                                                </div>
                                            </div>
                                            <div class="col-sm-1 text-right">
                                                <div class="form-group ini_button">
                                                <?php if($key == 0){ ?>
                                                    <a class="btn btn-info glyphicon glyphicon-plus add_field_button_impact ubah_icon"></a>
                                            <?php } else{ ?>
                                                <a class="btn btn-danger glyphicon glyphicon-remove remove_field_impact ubah_icon"></a>
                                            <?php } ?>
                                        ...
                                        <div class="col-sm-1 text-right">
                                            <div class="form-group ini_button">
                                                <a class="btn btn-info glyphicon glyphicon-plus add_field_button_target ubah_icon"></a>
                                                    ...
                                                    <?php }else{ foreach ($rkf['rkf_targetfin'] as $key=> $value) { ?>
                                <div class="target-bapak">
                                    <div class="row" style="">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input type="text" name='target_finansial[]' value="<?=$value['uraian']?>" placeholder='Uraian' class="form-control input-targetfin" style="max-width:95%" />
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <input type="number" name='target_kuantitatif[]' value="<?=$value['targetKuantitatif']?>" placeholder='Target Kuantitatif' class="form-control input-targetkuan" style="max-width:95%" />
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <select class="form-control input-targettahun" name="satuan[]" style="width: 90%; max-width: 90%; ">
                                                    <option value=""> Pilih Satuan</option>
                                                    <?php foreach ($all->allSatuan as $dtSatuan) { ?>
                                                        <option value="<?= $dtSatuan->satuan_nama ?>" <?php if($value['satuan']== $dtSatuan->satuan_nama){ echo "selected"; }?>><?= $dtSatuan->satuan_nama ?></option>
                                                    <?php  } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-1 text-right">
                                            ...
                                            <?php if($key == 0){ ?>
                                                <a class="btn btn-info glyphicon glyphicon-plus add_field_button_target ubah_icon"></a>
                                            <?php } else{ ?>
                                                <a class="btn btn-danger glyphicon glyphicon-remove remove_field_target ubah_icon"></a>
                                            <?php } ?>
                            ...
                            <?php if(empty($rkf['rkf_anggaran'])){ ?>
                                <div class="coa-bapak">
                                    ...
                                    <div class="border-bottom" style="margin:10px 10px"></div>
                                                ...
                                                <?php }else{ foreach($rkf['rkf_anggaran'] as $key=> $dtAng){?>
                                              <?php 
                                                $id = $dtAng['coa'];
                                              ...
                                              $jenis_coa_edit = ($filterAng->pos_coa_jenis == "pbl") ? "LABA RUGI": "NERACA";
                                              ?> 
                                <div class="coa-bapak">
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                                if(!empty($coa_jenis)){
                                                                    foreach ($coa_jenis as $dt) { ?>
                                                                        <option style="text-transform:capitalize" value="<?=$dt;?>" <?=($dt == $jenis_coa_edit  )? "selected":"" ;?>><?=$dt; ?></option>;
                                                            <?php }} ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-9" style="background-color:">
                                            <div class="form-group">
                                                ...
                                                <?php foreach($coa as $dt){ ?>
                                                              ...
                                                              <option style="font-style:italic" value="<?=$dt->pos_coa_sub3_id?>" <?=($dtAng['coa'] == $dt->pos_coa_sub3_id)? "selected":"" ; ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $dt->pos_coa_sub3_id.' - '.$dt->pos_coa_sub3_nama;?></option>
                                                            <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-1 text-right">
                                            ...
                                            <?php if($key == 0){ ?>
                                                <a class="btn btn-info glyphicon glyphicon-plus add_field_button_coa ubah_icon"></a>
                                            <?php } else{ ?>
                                                <a class="btn btn-danger glyphicon glyphicon-remove remove_field_coa ubah_icon"></a>
                                            <?php } ?>
                            ...
                            <?php if(empty($rkf['rkf_unit_pelaksana'])){ ?>
                                <div class="pic-bapak">
                                    ...
                                    <?php }else{  foreach ($rkf['rkf_unit_pelaksana'] as $keymaster => $value){ $nip = $value['pegawaiUnitKerja'];   ?>
                                <div class="pic-bapak">
                                    <div class="row" style="">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <select class="form-control selectsubdiv reset-pic" name="subdivisi[]" style=" max-width: 98%;">
                                                    ...
                                                    <?php
                                                    if (!empty($subdiv->result)) {
                                                        foreach ($subdiv->result[0] as $key => $dt) { ?>
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            ?>
                                                <select class="form-control selectpic reset-pic" name="pic[]" style=" max-width: 98%;">
                                                <?php foreach($dataPegawai as $dtPeg){ ?>
                                                        <option value="<?=$dtPeg->pegawai_id; ?>" <?=($dtPeg->pegawai_id == $nip)? 'selected':''; ?> > <?=$dtPeg->nama; ?></option>
                                                <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-1 text-right">
                                            ...
                                            <?php if($keymaster == 0){ ?>
                                                <a class="btn btn-info glyphicon glyphicon-plus add_field_button_pic ubah_icon"></a>
                                            <?php } else{ ?>
                                                <a class="btn btn-danger glyphicon glyphicon-remove remove_field_pic ubah_icon"></a>
                                            <?php } ?>
                                    ...
                                    <div class="row" style="">
                                        ...
                                        <div class="col-sm-1 text-right">
                                            <div class="form-group ini_button">
                                                ...
                                                <?php }else{ foreach ($rkf['rkf_fungsilain'] as $keymaster => $value){  ?>
                                <div class="support-bapak">
                                    <div class="row" style="">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-group">
                                                <input type="text" name='notes[]' value="<?=$value['notes']?>" placeholder='Sampaikan support yang diperlukan...' class="form-control reset-support" />
                                        ...
                                        <div class="col-sm-1 text-right">
                                            ...
                                            <?php if($keymaster == 0){ ?>
                                                <a class="btn btn-info glyphicon glyphicon-plus add_field_button_support ubah_icon"></a>
                                            <?php } else{ ?>
                                                <a class="btn btn-danger glyphicon glyphicon-remove remove_field_support ubah_icon"></a>
                                            <?php } ?>
                            ...
                            <div class= "pabnya" style="display:<?=(!empty($dataPab) || $rkf['rkf_kat_proker'] == 4)? '':'none'; ?>">
                                <div class="row">
                                    <div class="col-sm-12 ">
                                        <div class="form-group">
                                ...
                                <div class="row" style="">
                                    ...
                                    <label class="control-label" style="text-align:left;">Jenis</label>
                                            <select class="form-control reset-support select-jenis-pab" name="pab_jenis" style="max-width: 98%;">
                                                ...
                                                <option value="1" <?=(!empty($dataPab->pab_jenis) && $dataPab->pab_jenis == 1)? 'selected':''; ?>>Produk Baru</option>
                                                <option value="2" <?=(!empty($dataPab->pab_jenis) && $dataPab->pab_jenis == 2)? 'selected':''; ?>>Aktivitas Baru</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <label class="control-label" style="text-align:left;">Nama Produk/Aktivitas Baru</label>
                                            <input type="text" name='pab_nama' placeholder='' class="form-control reset-support" value="<?=(!empty($dataPab->pab_nama))? $dataPab->pab_nama:''; ?>"/>
                                ...
                                <div class="row" style="">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name='pab_tujuan_bank' placeholder='' class="form-control reset-support" style="max-width: 98%;" value="<?=(!empty($dataPab->pab_tujuan_bank))? $dataPab->pab_tujuan_bank:''; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                    <label class="control-label" style="text-align:left;">Tujuan/Manfaat Bagi Nasabah</label>
                                            <input type="text" name='pab_tujuan_nasabah' placeholder='' class="form-control reset-support" value="<?=(!empty($dataPab->pab_tujuan_nasabah))? $dataPab->pab_tujuan_nasabah:''; ?>"/>
                                ...
                                <div class="row" style="">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name='pab_keterkaitan' placeholder='' class="form-control reset-support" style="max-width: 98%;" value="<?=(!empty($dataPab->pab_keterkaitan))? $dataPab->pab_keterkaitan:''; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control " name="pab_jadwal">
                                                        <?php for($i=1; $i<=12;$i++){ ?>
                                                        <option value="<?=$i?>" <?=(!empty($dataPab->pab_jadwal_bulan) && $dataPab->pab_jadwal_bulan == $i)? 'selected':''; ?>><?=parse_bulan_short($i); ?></option>
                                                        <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row" style="">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name='pab_resiko' placeholder='' class="form-control reset-support" style="max-width: 98%;" value="<?=(!empty($dataPab->pab_resiko)) ? $dataPab->pab_resiko:''; ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                    <label class="control-label" style="text-align:left;">Mitigasi Risiko atas Penerbitan Produk dan/Atau Aktivitas Baru</label>
                                            <input type="text" name='pab_mitigasi' placeholder='' class="form-control reset-support" value="<?=(!empty($dataPab->pab_mitigasi_resiko))? $dataPab->pab_mitigasi_resiko:''; ?>" />
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name='pab_deskripsi' placeholder='' class="form-control reset-support" value="<?=(!empty($dataPab->pab_deskripsi))? $dataPab->pab_deskripsi:''; ?>"/>
...
<script>
$('.numbernya').mask('000,000,000,000,000', {reverse: true});
</script>
<script>
tippy('.tippy-outcome', {
...
<script>
    ...
    // untuk perubahan saat select subdiv
