            ...
            <div class="row">
                <div class="col-sm-2 pull-left " style="padding-bottom:0px">
                    <select id="filter-select"  class="form-control " name="bulan">
                        ...
                        <option value="4">Isu Strategis</option>
                        <option value="5" >KUD</option>
                        <option value="6" selected>Transformasi</option>
                    </select>
                </div>
                    ...
                    <table id="example" class="table  table-bordered table-hover" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center; vertical-align:middle;width:10%">Transformasi</th>
                        ...
                        <tbody>
                            <?php foreach ($data as $keyrkf => $dt) { ?>
                                <tr>
                                    ...
                                    <td><b><?php echo (!empty($dt->transformasi_bpd_nama)) ? $dt->transformasi_bpd_nama:"-"; ?></b></td>
