<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.6.9.693f7e9.css');
    ...
    if ($load_react) {
        $this->setJavaScriptFile($this->_assetsFolder . 'js/libraries/react/react.v16.5.2' . $minify_or_not . '.js');
    }
    ...
    if ($autoload_javascript) {
        $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.6.9.693f7e9' . $minify_or_not . '.js');
    } else {
        $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-no-autoload-v2.6.9.693f7e9' . $minify_or_not . '.js');
    }
