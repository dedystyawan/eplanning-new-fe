...
class GroceryCrud implements GroceryCrudInterface
{
     ...
     * @var array
     */
    protected $_callbackAddField = [];

    /**
     * @var array
     */
    protected $_callbackEditField = [];

    /**
     * @var array
     */
    protected $_callbackReadField = [];
    ...
    {
        $this->_callbackAddField[$fieldName] = $callback;
        return $this;
    }
    ...
    {
        $this->_callbackEditField[$fieldName] = $callback;
        return $this;
    }
    ...
    {
        $this->_callbackReadField[$fieldName] = $callback;
        return $this;
    }
     ...
     * @throws \Exception
     */
    public function fieldTypeAddForm($fieldName , $fieldType)
    {
     ...
     * @throws \Exception
     */
    public function fieldTypeColumn($columnName, $columnType) {
     ...
     * @throws \Exception
     */
    public function fieldTypeEditForm($fieldName , $fieldType)
    {
        if ($fieldType instanceof ModelFieldType) {
     ...
     * @throws \Exception
     */
    public function fieldTypeReadForm($fieldName , $fieldType)
    {
        if ($fieldType instanceof ModelFieldType) {
     ...
     * @throws \Exception
     */
    public function fieldTypeFormFields($fieldName , $fieldType)
    {
        $this->fieldTypeAddForm($fieldName , $fieldType);
        $this->fieldTypeEditForm($fieldName , $fieldType);
        $this->fieldTypeReadForm($fieldName , $fieldType);
    ...
    public function getCallbackEditFields() {
        return $this->_callbackEditField;
    }
    ...
    public function getCallbackReadFields() {
        return $this->_callbackReadField;
    }
