<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.4.1.7b293a1.css');
    ...
    if ($load_react) {
        $this->setJavaScriptFile($this->_assetsFolder . 'js/libraries/react/react.v16.0.0' . $minify_or_not . '.js');
    }
    ...
    if ($autoload_javascript) {
        $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.4.1.7b293a1' . $minify_or_not . '.js');
    } else {
        $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-no-autoload-v2.4.1.7b293a1' . $minify_or_not . '.js');
    }
